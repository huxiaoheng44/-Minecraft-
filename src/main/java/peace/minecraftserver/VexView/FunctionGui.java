...
public class FunctionGui {
    ...
    public static VexGui FunctionCharge(Player player){
        ...
        vexComponentsList.add(new VexButton("buyTele","定点传送","[local]button.png","[local]button_.png",175,225,80,30,player1 -> {
    ...
    public static VexGui SetLocation(Player player){
        ...
        vexComponentsList.add(new VexButton("homeLoc","家","[local]button.png","[local]button_.png",-1,40,40,20));
        vexComponentsList.add(new VexButton("otherPlayerLoc","其他玩家","[local]button.png","[local]button_.png",-1,80,40,20));
        vexComponentsList.add(new VexTextArea(-1,120,30,15,4,4));
        vexComponentsList.add(new VexButton("setLoc","自定义","[local]button.png","[local]button_.png",-1,140,40,20));
        //参数 x y 编辑长度 宽度 最大字数 id
        vexComponentsList.add(new VexTextArea(80,180,30,15,4,1));
        vexComponentsList.add(new VexTextArea(120,180,30,15,4,2));
        vexComponentsList.add(new VexTextArea(160,180,30,15,4,3));
        //标题
        vexComponentsList.add(new VexText(75,15,Arrays.asList("地点选择"),99));
        return new VexGui("[local]gui.png",-1,-1,200,230,vexComponentsList);
    }
}
