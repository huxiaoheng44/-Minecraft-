...
public class InsureGui {
    ...
    public static VexGui InsurePurchase(Player player){
        ...
        //参数 x y 内容 字体大小
        vexComponentsList.add(new VexText(30,70,Arrays.asList("钻石保险","返还钻石和金币","价格：100金币","达成条件：角色死亡"),1));
        ...
        vexComponentsList.add(new VexText(155,70,Arrays.asList("黄金保险","返还黄金","价格：50金币","达成条件：角色死亡"),1));
        ...
        vexComponentsList.add(new VexText(275,70,Arrays.asList("怪物保险","不受该种怪物伤害","价格：100金币","达成条件:被怪物击杀"),1));
